package com.example.wisetest.recorder;
...
//import com.example.wisetest.recorder.util.VideoUtils;
...
public class CustomRecordActivity extends Activity implements View.OnClickListener {
    ...
    private static class MyHandler extends Handler {
        ...
        public MyHandler(CustomRecordActivity activity) {
            mActivity = new WeakReference<CustomRecordActivity>(activity);
        }
     ...
     * @date 2015-3-16
     */
    @TargetApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1) @SuppressLint("NewApi") @SuppressWarnings("deprecation")
