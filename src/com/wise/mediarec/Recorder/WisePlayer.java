...
public class WisePlayer
{
    ...
    public WisePlayer() {
         ...
         */
        native_setup(new WeakReference<WisePlayer>(this));
    }
     ...
     *
     * @see WisePlayer#VIDEO_SCALING_MODE_SCALE_TO_FIT
     * @see WisePlayer#VIDEO_SCALING_MODE_SCALE_TO_FIT_WITH_CROPPING
     */
     ...
     */
    public static WisePlayer create(Context context, Uri uri) {
     ...
     * @return a MediaPlayer object, or null if creation failed
     */
    public static WisePlayer create(Context context, Uri uri, SurfaceHolder holder) {

        try {
            WisePlayer mp = new WisePlayer();
     ...
     * @return a MediaPlayer object, or null if creation failed
     */
    public static WisePlayer create(Context context, int resid) {
        try {
    ...
    public void setWakeMode(Context context, int mode) {
        ...
        mWakeLock = pm.newWakeLock(mode|PowerManager.ON_AFTER_RELEASE, WisePlayer.class.getName());
    ...
    {
        private WisePlayer mMediaPlayer;

        public EventHandler(WisePlayer mp, Looper looper) {
            super(looper);
            mMediaPlayer = mp;
        }
    ...
    {
        WisePlayer mp = (WisePlayer)((WeakReference)mediaplayer_ref).get();
        if (mp == null) {
            return;
        }
    ...
    public interface OnCompletionListener
    {
         ...
         */
        void onCompletion(WisePlayer mp);
    }
    ...
    public interface OnBufferingUpdateListener
    {
         ...
         */
        void onBufferingUpdate(WisePlayer mp, int percent);
    }
    ...
    public interface OnSeekCompleteListener
    {
         ...
         */
        public void onSeekComplete(WisePlayer mp);
    }
    ...
    public interface OnVideoSizeChangedListener
    {
         ...
         */
        public void onVideoSizeChanged(WisePlayer mp, int width, int height);
    }
    ...
    public interface OnTimedTextListener
    {
         ...
         */
        public void onTimedText(WisePlayer mp, TimedText text);
    }
    ...
    public interface OnErrorListener
    {
         ...
         */
        boolean onError(WisePlayer mp, int what, int extra);
    }
    ...
    public interface OnInfoListener
    {
         ...
         */
        boolean onInfo(WisePlayer mp, int what, int extra);
    }
